                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="company" data-editable="true">Event Date</th>
                                        <th data-field="price" data-editable="true">Event Time</th>
                                        <th data-field="date" data-editable="true">Reminder Date</th>
                                        <th data-field="task" data-editable="true">Reminder Time</th>
                                        <th data-field="yjtht" data-editable="true">Description</th>
                                        <th data-field="sdfs" data-editable="true">Complete</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($event->is_complete)
                                                ...
                                                <button id="basicInfo" class="btn btn-info">Yes</button>
                                                @else
                                                <button id="basicInfo" class="btn btn-danger">No</button>
